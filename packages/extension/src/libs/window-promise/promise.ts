...
import UIRoutes from "@/ui/provider-pages/samara/routes/names";
import { ErrorCodes } from "@/providers/radiant/types";

const UNLOCK_PATH = getUiPath(UIRoutes.unlock.path, ProviderName.samara);
class WindowPromise {
