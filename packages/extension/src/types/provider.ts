import type { InjectedProvider as RadiantProvider } from "../providers/radiant/types";
...
import { BaseToken, UTXO } from "./base-token";
...
export enum InternalStorageNamespace {
  ...
  rvmAccountsState = "RVMAccountsState",
...
export enum SamaraProviderEventMethods {
  persistentEvents = "PersistentEvents",
}
...
export { RadiantProvider };
export type Provider = RadiantProvider;
