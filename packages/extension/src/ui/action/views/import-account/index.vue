  ...
  <div class="import-account__container">
    ...
    <div class="import-account__wrap">
      <import-account-start
        ...
        @select:extendedprivkey="extendedPrivateKeyAction"
        @close="close"
      />
...
import ImportAccountExtendedPrivateKey from "./views/import-account-extended-private-key.vue";
...
const isExtendedPrivateKey = ref(false);
...
const privateKeyAction = () => {
  ...
  isExtendedPrivateKey.value = false;
  isKeyStoreImport.value = false;
  isPrivKeyImport.value = true;
};


const extendedPrivateKeyAction = () => {
  allVars.forEach((val) => (val.value = false));
  isPrivateKey.value = false;
  isExtendedPrivateKey.value = true;
  isKeyStoreImport.value = false;
  isPrivKeyImport.value = true;
};
