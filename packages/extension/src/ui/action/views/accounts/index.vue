  ...
  <div class="accounts" :class="{ show: showAccounts }">
    ...
    <div class="accounts__wrap" :class="{ show: showAccounts }">
      ...
      >
        ...
        <div v-if="accountInfo.inactiveAccounts.length" class="accounts__info">Incompatible accounts</div>
      ...
      <div class="accounts__action">
        ...
        <div
          ...
          "
          class="accounts__action-divider d-none"
        />

        <a
          v-if="hwWallet.isNetworkSupported(network.name)"
          class="accounts__action-button hardware d-none"
...
import HWwallets from "@samaraapp/hw-wallets";
import { SignerType } from "@samaraapp/types";
import { BaseNetwork } from "@/types/base-network";
import { WalletType } from "@samaraapp/types";

const emit = defineEmits<{
  (e: "addressChanged", account: SamaraAccount): void;
}>();
...
const accountToRename = ref<SamaraAccount>();
const accountToDelete = ref<SamaraAccount>();
