  ...
  >
    <div class="network-activity__transaction-info">
      <div class="network-activity__transaction-info-name">
        <h4>
          {{ $filters.replaceWithEllipsis(activity.transactionHash, 6, 6) }}
        </h4>
        <p>
          <span
...
onMounted(() => {
  ...
  if (props.activity.height <= 0) {
    status.value = "Pending";
  } else if (props.activity.height > 0) {
    status.value = "Block #" + props.activity.height;
  }
});
</script>
