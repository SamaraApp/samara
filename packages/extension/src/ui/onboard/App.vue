<template>
  <div class="onboard__container">
    ...
    <div
      ...
      class="onboard__info"
    >
      <h4>Pin the Samara extension</h4>
      <p>Click on <extension-icon /> in your browser</p>
      <p>
        Find <online-icon class="onboard__online" /> Samara and click
        <pin-icon /> to pin it
      </p>
    </div>
  </div>
...
.onboard {
  ...
  &__container {
    background: url("./comet.jpg") no-repeat center center fixed;
