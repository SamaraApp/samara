...
enum SignerType {
  ecdsa = "ecdsa",         // Radiant?
  secp256k1 = "secp256k1", // Radiant | ethereum
}
...
interface SamaraAccount extends KeyRecord {
  isHardware: boolean;
...
interface SignerExtendedInterface {
  sign: (
    msgHash: string,
    keypair: KeyPair,
    options?: unknown
  ...
  decrypt: (message: any, keypair: any) => Promise<any>;
  getEncryptionPublicKey: (keypair: any) => Promise<string>;
}
