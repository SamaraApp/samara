...
import { HWwalletCapabilities, NetworkNames } from "@samaraapp/types";
import HDKey from "hdkey";
import { bufferToHex, hexToBuffer, numberToHex } from "@samaraapp/utils";
...
class TrezorEthereum implements HWWalletProvider {
  ...
  async init(): Promise<boolean> {
    TrezorConnect.manifest({
      email: "samaraapp@proton.me",
      appUrl: "https://samara.app",
    });
    return true;
  }
